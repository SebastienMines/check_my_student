...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="st-navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
				    	<li><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myInscription">Inscription</button></li>
				    	<li><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myConnection">Connexion</button></li>
	...
	<!-- /SLIDER -->
	  ...
	  <!-- Modal -->
	  <div class="modal fade" id="myConnection" role="dialog">
	    <div class="modal-dialog">
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	          <form method="POST" action="php/isconnected.php">
	  ...
	  <!-- Modal Inscription-->
	  <div class="modal fade" id="myInscription" role="dialog">
	    <div class="modal-dialog">
